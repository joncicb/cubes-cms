...
class Application_Form_Admin_IndexSlideAdd extends Zend_Form
{
    public function init() {
        ...
        $indexSlidePhoto->addValidator('Count', true, 1)//true se stavlja da ako ne prodje validator prekida se izvrsavanje validacije na nivou elementa forme a ne cele forme
